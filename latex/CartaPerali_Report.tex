...
Different Convolutional Neural Network architectures are deployed and compared, highlighting the results obtained in terms of efficiency, memory and computational speed.\\
\end{abstract}
