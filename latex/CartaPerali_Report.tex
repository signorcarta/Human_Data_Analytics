...
\begin{abstract}
 Speech recognition is an interdisciplinary subfield of computer science that aim at developing systems capable of translating spoken language into text. In this paper different architechtures are investigated, comparing results and tradeoffs. Features are extracted through {\it [different techniques i.e.]} MFCC coefficients {\it [and maybe other types of features extraction.]}
\\ Different types of Neural Networks i.e. Convolutional and Recurrent are deployed and compared with a Hidden Markov Model, highlighting the results obtained in terms of efficiency, memory and computational speed.\\
\end{abstract}

\IEEEkeywords
 Convolutional Neural Networks, Recurrent Neural Networks, Hidden Markov Models, Supervised Learning, Automatic Speech Recognition. 
\endIEEEkeywords
